...
const QucikPick = ({ rowSize, multiWidth, totalBlocks }: IProps) => { //ici je remplace par le tableau total des éléments "les suggestion de réponse"
  ...
  }, [rowSize, multiWidth, totalBlocks]);//fonction recalculer si une de ses valeurs changes
  ...
  return (
<Stack style={{ height: '100%', width: '100%', display:"flex", justifyContent:"center"}} fullHeight flexDirection="column">
